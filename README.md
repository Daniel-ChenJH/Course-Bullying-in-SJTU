...
4. 添加了成功抢课后信息反馈模块。
5. MAC版程序体积大幅减小。
6. 如果程序登录成功但是持续报错IndexError: list index out of range，此错误出现原因为：当前网络环境不佳，程序刷新过快取到空值。请改用文件列表中的sleep1WIN64-Course-Bullying-in-SJTU-v5_5.exe版即可。
